      ...
      <main className="dashboard-main-content">
        ...
        {activeTab === 'orders' && (
          <div className="glass-panel">
            ...
            <p className="subtext" style={{ marginBottom: '1.5rem' }}>Advance order stages (Order Placed → In Transit → Out for Delivery → Delivered).</p>
            ...
            <table className="dashboard-table">
              ...
              <tbody>
                {allOrders.length === 0 ? (
                  <tr><td colSpan="6" style={{ fontStyle: 'italic', textAlign: 'center' }}>No customer orders placed yet.</td></tr>
                ) : (
                  allOrders.map(ord => (
                    <tr key={ord.orderId}>
                      ...
                      <td>
                        ...
                        >
                          ...
                          <option value="In Transit">2. In Transit</option>
